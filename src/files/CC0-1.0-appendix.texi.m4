...
rules_code({%|src/files/CC0-1.0-appendix.texi|%}){%||%}dnl
...
@c Universal Public Domain Dedication. It can be included in a Texinfo
@c document where the appendix is desired to appear. The appendix is
@c labeled with @node Creative Commons Zero@tie{}@w{1-0} so that it
@c maintains the usual node structure and can be cross-referenced.
@c
@end ifnotxml
@end ifxml
