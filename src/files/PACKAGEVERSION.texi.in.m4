...
@set PACKAGEVERSIONDOCKER @PACKAGE_VERSION_DOCKER@
@set PACKAGEVERSIONGIT @PACKAGE_VERSION_GIT@
...
@set PACKAGEVERSIONRPMR @PACKAGE_VERSION_RPM_R@
@set PACKAGEVERSIONRPMV @PACKAGE_VERSION_RPM_V@
@set PACKAGEVERSIONRPMVR @PACKAGE_VERSION_RPM_VR@
