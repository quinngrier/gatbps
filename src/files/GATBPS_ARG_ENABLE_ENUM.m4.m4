...
rules_code({%|src/files/GATBPS_ARG_ENABLE_ENUM.m4.m4|%}){%||%}dnl
...
dnl
dnl Special file: GATBPS_ARG_ENABLE_ENUM.m4
dnl
...
{%|
AC_DEFUN([GATBPS_ARG_ENABLE_ENUM_foo1], [dnl
m4_if(
  m4_eval([$# >= 2]),
  [1],
  [[
...
m4_if(
  m4_eval([$# >= 4]),
  [1],
  [GATBPS_ARG_ENABLE_ENUM_foo1(m4_shift2($@))])[]dnl
])[]dnl
AC_DEFUN([GATBPS_ARG_ENABLE_ENUM_foo2], [dnl
m4_if(
  m4_eval([$# >= 3]),
  [1],
  [[
...
m4_if(
  m4_eval([$# >= 5]),
  [1],
  [GATBPS_ARG_ENABLE_ENUM_foo2([$1], m4_shift3($@))])[]dnl
])[]dnl
AC_DEFUN([GATBPS_ARG_ENABLE_ENUM], [[{
