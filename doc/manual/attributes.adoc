...
:acl_GATBPS_DEDUCE_WYNA_url: acl_GATBPS_DEDUCE_WYNA.adoc#acl-GATBPS-DEDUCE-WYNA
:acl_GATBPS_DEDUCE_WYNA: link:{acl_GATBPS_DEDUCE_WYNA_url}[GATBPS_DEDUCE_WYNA]
