...
:acl_GATBPS_SOFT_VAR: xref:acl_GATBPS_SOFT_VAR.adoc#acl_GATBPS_SOFT_VAR[GATBPS_SOFT_VAR]
...
:acl_GATBPS_WITH_ENUM_url: acl_GATBPS_WITH_ENUM.adoc#acl-GATBPS-WITH-ENUM
:acl_GATBPS_WITH_ENUM: link:{acl_GATBPS_WITH_ENUM_url}[GATBPS_WITH_ENUM]
