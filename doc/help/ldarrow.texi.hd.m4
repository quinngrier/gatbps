...
rules_code({%|doc/help/ldarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}ldarrow.texi${fR1}

The ${fB1}ldarrow.texi${fR1} special file defines the ${fB1}@ldarrow${fR1} Texinfo macro, which
