...
rules_code({%|doc/help/lrdarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}lrdarrow.texi${fR1}

The ${fB1}lrdarrow.texi${fR1} special file defines the ${fB1}@lrdarrow${fR1} Texinfo macro,
