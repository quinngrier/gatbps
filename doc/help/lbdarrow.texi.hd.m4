...
rules_code({%|doc/help/lbdarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}lbdarrow.texi${fR1}

The ${fB1}lbdarrow.texi${fR1} special file defines the ${fB1}@lbdarrow${fR1} Texinfo macro,
