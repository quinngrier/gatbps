...
rules_code({%|doc/help/lbarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}lbarrow.texi${fR1}

The ${fB1}lbarrow.texi${fR1} special file defines the ${fB1}@lbarrow${fR1} Texinfo macro, which
