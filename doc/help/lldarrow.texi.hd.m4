...
rules_code({%|doc/help/lldarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}lldarrow.texi${fR1}

The ${fB1}lldarrow.texi${fR1} special file defines the ${fB1}@lldarrow${fR1} Texinfo macro,
