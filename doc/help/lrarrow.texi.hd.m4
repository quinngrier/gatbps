...
rules_code({%|doc/help/lrarrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}lrarrow.texi${fR1}

The ${fB1}lrarrow.texi${fR1} special file defines the ${fB1}@lrarrow${fR1} Texinfo macro, which
