...
rules_code({%|doc/help/barrow.texi.hd.m4|%}){%||%}dnl
rules_code({%|src/tools/rules_code.m4|%}){%||%}dnl
{%|Special file: ${fB1}barrow.texi${fR1}

The ${fB1}barrow.texi${fR1} special file defines the ${fB1}@barrow${fR1} Texinfo macro, which
