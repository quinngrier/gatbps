#
# This file was generated by GATBPS 0.0.0-1722-g6654c2f, which was
# released on 2015-12-08. Before changing it, make sure
...
`
          ...
          #(
            *)
              cat >&2 <<EOF2
${fr2}sh-form.sh!${fR2} ${fB2}${sed}${fR2} failed to read from:
${fr2}sh-form.sh!${fR2}   1. a here-document
${fr2}sh-form.sh!${fR2} and write to: a command substitution
EOF2
              exit '1'
            ;;
          esac
...
EOF2
          ...
          #(
            *)
              cat >&2 <<EOF2
${fr2}sh-form.sh!${fR2} ${fB2}${awk}${fR2} failed to read from:
${fr2}sh-form.sh!${fR2}   1. a here-document
${fr2}sh-form.sh!${fR2} and write to: standard error
EOF2
            ;;
          esac
          exit '1'
...
#(
  *)
    cat >&2 <<EOF2
${fr2}sh-form.sh!${fR2} ${fB2}cat${fR2} failed to read from:
...
#(
  *)
    cat >&2 <<EOF2
${fr2}sh-form.sh!${fR2} ${fB2}echo${fR2} failed to write to: a command substitution
EOF2
    exit '1'
  ;;
esac
...
${fr2}sh-form.sh!${fR2} ${fB2}${sed}${fR2} failed to read from:
${fr2}sh-form.sh!${fR2}   1. a here-document
${fr2}sh-form.sh!${fR2} and write to: standard output
EOF2
    exit '1'
  ;;
esac
